...
(function () {
    ...
    function getRelativePosition(e, obj) {
        ...
        pos = findPos(obj);
        x -= pos[0] + obj.offsetWidth/2;
        y -= pos[1] + obj.offsetHeight/2;
    ...
    var panZoomFunctions = {
        ...
        PanZoom = function (el, options) {
            ...
            settings.repaintCallback = options.repaintCallback || null;
            ...
            function repaint() {
                ...
                paper.setViewBox(me.currPos.x - newWidth/2, me.currPos.y - newHeight/2, newWidth, newHeight);

                if (settings.repaintCallback) {
                    settings.repaintCallback(me.currPos, 1 - (me.currZoom*settings.zoomStep));
                }
            }
