define(["qunit", "../tools/kicad_viewer/fp_parser", "sexpression"],
    function(Q, FPS, SExp) {
  ...
  (lib (name Buzzers_Beepers)(type Github)(uri ${KIGITHUB}/Buzzers_Beepers.pretty)(options "")(descr "The way you like them."))\n\
        ...
        test( "Parse fp_line", function() {
            var fps = new FPS();
            var line = SExp.parse("(fp_line (start -2.032 -4.445) (end -1.651 -4.572) (layer F.SilkS) (width 0.254))");
        ...
        test( "Parse pad", function() {
            var fps = new FPS();
            var line = SExp.parse("(pad 1 thru_hole rect (at 0 2.54) (size 1.99898 1.99898) (drill 0.8001) (layers *.Cu *.Mask F.SilkS))");
